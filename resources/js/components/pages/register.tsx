...
import { Eye, EyeOff, Mail, Lock, User as UserIcon, ArrowRight, CheckCircle, AlertCircle } from 'lucide-react';
// @ts-ignore
        ...
        if (validateForm()) {
            ...
            register(user).then(() => {
                ...
                addNotification({
                    ...
                    message: 'Hubo un problema al enviar tu solicitud de registro. Por favor, intenta nuevamente.',
                    duration: 5000
                });
            });
        } else {
                ...
                {isSubmitted ? (
                                ...
                                <div className="space-y-3 text-muted-foreground">
                                    ...
                                    <div className="bg-muted/50 rounded-lg p-4 space-y-2">
                                        ...
                                        <ul className="text-sm space-y-1 text-left">
                                            <li>• El sistema está en <span className="font-medium text-primary">beta testing</span></li>
                                            <li>• Un administrador debe aprobar tu cuenta</li>
                                            <li>• Te notificaremos por email cuando tu cuenta sea activada</li>
                                            <li>• El proceso puede tomar entre 24-48 horas</li>
                                        </ul>
                                    </div>
                                    <p className="text-sm">
                                        Gracias por tu paciencia y por ser parte de nuestro programa beta.
                                    </p>
                                </div>
                            </div>
                            <div className="pt-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className={`block w-full pl-10 pr-3 py-3 border rounded-xl focus:ring-2 focus:ring-ring focus:border-transparent transition-all duration-200 bg-background focus:bg-background ${
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`block w-full pl-10 pr-12 py-3 border rounded-xl focus:ring-2 focus:ring-ring focus:border-transparent transition-all duration-200 bg-background focus:bg-background ${
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-sm text-muted-foreground">
                            ...
                            <a href="/app/login" className="font-medium text-primary hover:text-primary/80 transition-colors">
                                Inicia sesión
                            </a>
                        </p>
                    </div>
